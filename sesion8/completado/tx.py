...
class Tx:
    ...
    def serializar(self):
        ...
        # codificar_varint el número de outputs
    ...
    def firmar_input(self, índice_input, clave_privada, tipo_hash):
        ...
        # devuelve si sig es válido usando self.verificar_input
    ...
    def es_coinbase(self):
        ...
        # comprueba que el primer input tx_previa sea b'\x00' * 32 bytes
        if primer_input.tx_previa != b'\x00' * 32:
            return False
        # comprueba que el primer input índice_previo sea 0xffffffff
...
class TxIn:
    ...
    def sec_pubkey(self):
        '''devuelve el format público SEC si el script_sig tiene uno'''
