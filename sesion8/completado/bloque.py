...
class Bloque:
    ...
    def bip9(self):
        ...
        # recuerda versión es 32 bytes así que mueve a la derecha 29 (>> 29) y comprueba
        # que es 001
        return self.versión >> 29 == 0b001

    def bip91(self):
        '''Devuelev si este bloque señaliza estar listo para BIP91'''
        # BIP91 se señaliza si el 5º bit desde la derecha es 1
        # mueve 4 bits a la derecha y mirael el último es 1
        return self.versión >> 4 & 1 == 1

    def bip141(self):
        '''Devuelve si este bloque seañaliza estar listo para BIP141'''
        # BIP91 se señaliza si el 2º bit desde la derecha es 1
    ...
    def dificultad(self):
        ...
        # nota que la dificultad es (target de mínima dificultad) / (target de self)
    ...
    def validar_raíz_merkle(self):
        ...
        lo mismo que la raíz merkle de este bloque
        '''
