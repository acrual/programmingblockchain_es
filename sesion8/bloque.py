...
HASH_BLOQUE_GÉNESIS = bytes.fromhex('000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f')
HASH_BLOQUE_GÉNESIS_TESTNET = bytes.fromhex('000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943')
...
class Bloque:
    ...
    def bip9(self):
        ...
        # BIP9 se señaliza si los top 3 bites son 001
        # recuerda que la versión es 32 bytes así que muévete hacia la derecha 29 (>> 29)
        # y comprueba si eso es 001
    ...
    def bip91(self):
        ...
        # muévete 4 bits a la derecha y mira si el último es 1
    ...
    def bip141(self):
        ...
        # muévete 1 bit a la derecha y mira si el último es 1
    ...
    def dificultad(self):
        ...
        # nota que la dificultad es (target de mínima dificultad) / (target de self's)
    ...
    def validar_raíz_merkle(self):
        '''Obtiene la raíz merkle de los tx_hashes y comprueba que es la misma que
        la raíz merkle de este bloque
        '''
        # dale la vuelta a todos los hashes de transacciones (self.tx_hashes)
        hashes = [h[::-1] for h in self.tx_hashes]
        # obtiene la Raíz de Merkle
        raíz = raíz_merkle(hashes)
        # dale la vuelta a la Raíz Merkle
        # devuelve si la raíz self.merkle es la misma que
        # el reverso de la raíz de merkle calculada
