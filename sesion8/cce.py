...
class ElementoCampo:
    ...
    def __sumar__(self, otro):
        if self.primo != otro.primo:
            raise TypeError('No se pueden sumar dos números en campos diferentes')
...
class Punto:
    ...
    def __init__(self, x, y, a, b):
        ...
        # Compruébalo aquí ya que de otra forma la ecuación de abajo no tendrá sentido
...
class PruebaCCE(TestCase):
    ...
    def prueba_en_curva(self):
        ...
        # itera por los puntos inválidos
...
class PuntoS256(Punto):
    ...
    def __rmul__(self, coeficiente):
        # haremos el módulo por N para hacer esto más sencillo
        coef = coeficiente % N
    ...
    def parsear(self, sec_bin):
        '''devuelve un objeto Punto desde el sec binario comprimido (no hex)
        '''
        if sec_bin[0] == 4:
        ...
        # la parte derecha de la ecuación y^2 = x^3 + 7
...
class PruebaS256(TestCase):
    ...
    def prueba_puntopub(self):
        ...
        for secreto, x, y in puntos:
            ...
            punto = PuntoS256(x, y)
            # comprueba que secreto*G es el mismo que el punto
