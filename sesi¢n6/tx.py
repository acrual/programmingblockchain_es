...
class Tx:
    ...
    def parsear(cls, s, testnet=False):
        ...
        # num_inputs es varint, usa read_varint(s)
        num_inputs = read_varint(s)
        # cada input necesita parseo
        inputs = []
        for _ in range(num_inputs):
            inputs.append(TxIn.parsear(s))
        # num_outputs es varint, usa read_varint(s)
    ...
    def sig_hash(self, indice_input, tipo_hash):
        '''Devuelve la representación entera del hash que necesitamos firmar
        para índice indice_input'''
        # crear una nueva serie de tx_ins (alt_tx_ins)
        alt_tx_ins = []
        ...
        # obtén el input en indice_input
        ...
        # crea una transacción alternativa con los modified tx_ins
    ...
    def es_coinbase(self):
        ...
        # comprueba que hay exactamente 1
        # obtén el primero input
        # comprueba que el primer input de tx_previa es b'\x00' * 32 bytes
        # comprueba que el primer input indice_previo es 0xffffffff
    ...
    def altura_coinbase(self):
        ...
        # y luego la primera cosa del script_sig (.script_sig.cosas[0])
        # convierte la primera cosa de little endian a int
        raise NotImplementedError
...
class TxIn:
    ...
    def serializar(self):
        '''Devuelve la serialización del input de la transacción'''
    ...
    def sec_pubkey(self):
        '''devuelve el formato SEC público si el script_sig lo tiene'''
