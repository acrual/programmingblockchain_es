...
class Punto:
    ...
    def __init__(self, x, y, a, b):
        ...
        self.x = x
        self.y = y
        # con x e y iguales a None, lo que tenemos es el punto en el infinito
        # Compruébalo porque sino la ecuación abajo no tendrá sentido
        # con ambos valores iguales a None
        if self.x is None and self.y is None:
            return
        # asegúrate de que se satisface la curva elíptica
        # y**2 == x**3 + a*x + b
    ...
    def __add__(self, otro):
        ...
        # Caso 3: self.x == other.x, self.y == otro.y
        else:
    ...
    def __rmul__(self, coeficiente):
        ...
        # empieza el producto desde 0 (punto en el infinito)
...
class PruebaCCE(TestCase):
    ...
    def prueba_en_curva(self):
        # comprueba si los siguientes puntos están en la siguiente curva o no
        ...
        for x_bruto, y_bruto in puntos_inválidos:
            ...
            x = ElementoCampo(x_bruto, primo)
            y = ElementoCampo(y_bruto, primo)
            # comprueba que crear los puntos resulta en un RuntimeError
            # with self.assertRaises(RuntimeError):
            #     Punto(x, y, a, b)
            with self.assertRaises(RuntimeError):
                Punto(x, y, a, b)
    ...
    def prueba_suma1(self):
        # comprueba que las siguientes sumas estén en la curva y^2=x^3-7 sobre F_223:
        # (192,105) + (17,56)
        # (47,71) + (117,141)
        # (143,98) + (76,66)
        primo = 223
...
class PuntoS256(Punto):
    ...
    def __rmul__(self, coeficiente):
        ...
        coef = coeficiente % N
        # el actual soportará una expansión binaria
        actual = self
        # res es lo que devolvemos, empieza en 0
        res = PuntoS256(None, None)
        # doblamos 256 veces y añadimos donde haya 1 en la representación
    ...
    def verificar(self, z, fir):
        # recuerda fir.r y fir.s son las principales cosas a comprobar
...
class PruebaS256(TestCase):
    ...
    def prueba_puntopub(self):
        ...
        for secreto, x, y in puntos:
            ...
            punto = PuntoS256(x, y)
            # comrpueba que secreto*G de lo mismo que el punto
...
class ClavePrivada:
    ...
    def wif(self, comprimido=True, testnet=False):
        # convierte el secreto desde entero a 32-bytes en big endian usando num.to_bytes(32, 'big')
