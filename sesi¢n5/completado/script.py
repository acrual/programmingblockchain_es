...
def script_p2pkh(h160):
    '''Toma un hash160 y devuelve un scriptPubKey'''
...
class Script:
    ...
    def parsear(cls, s):
        ...
        contador = 0
        # haz un bucle hasta que leamos la longitud de bytes
        while contador < longitud:
            ...
            if byte_actual >= 1 and byte_actual <= 75:
                # tenemos una cosa n para ser el byte actual
                n = byte_actual
                ...
                # tenemos un op code. establece el byte actual como op_code
                op_code = byte_actual
