...
class Tx:
    ...
    def comisión(self):
        ...
        for tx_out in self.tx_outs:
            # para cada output obtén la cantidad y añádelo a output sum
...
class TxIn:
    ...
    def valor(self, testnet=False):
        '''Obtén el valor del outpoint mirándolo en el hash de la tx
