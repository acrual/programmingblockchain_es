    ...
    def parsear(cls, s):
        ...
        while contador < longitud:
            ...
            if byte_actual >= 1 and byte_actual <= 75:
                # tenemos una serie de cosas para que sean el byte actual
                n = byte_actual
                ...
                # tenemos un op code. establece el op_code como el byte_actual
                op_code = byte_actual
    ...
    def serializar(self):
        ...
        for cosa in self.cosas:
            ...
            if type(cosa) == int:
                ...
                # de otra forma, esto será un elemento
...
class PruebaScript(TestCase):
    ...
    def prueba_dire(self):
        ...
        script_pubkey = Script.parsear(BytesIO(raw_script))
