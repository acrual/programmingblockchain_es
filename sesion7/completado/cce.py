...
class ElementoCampo:
    ...
    def __add__(self, otro):
        ...
        # self.primo es contra lo que necesitarás calcular el módulo
        primo = self.primo
    ...
    def __mul__(self, otro):
        if self.primo != otro.primo:
            raise TypeError('No puedes sumar dos números en campos distintos')
        # self.num y otro.num son los valores reales
        num = (self.num * otro.num) % self.primo
...
class Punto:
    ...
    def __init__(self, x, y, a, b):
        ...
        # Compruébalo aquí pues de otra manera la ecuación abajo no tendrá sentido
    ...
    def __add__(self, otro):
        ...
        # Resultado es el punto en el infinito
...
class PruebaCCE(TestCase):
    ...
    def prueba_en_curva(self):
        # comprueba si los siguientes puntos están en la curva o no
    ...
    def prueba_rmul(self):
        ...
        for s, x1_bruto, y1_bruto, x2_bruto, y2_bruto in multiplicaciones:
            ...
            y1 = ElementoCampo(y1_bruto, primo)
            p1 = Punto(x1, y1, a, b)
            # inicializa el segundo punto basado en si es el punto en el infinito o no
            # x2 = ElementoCampo(x2_bruto, primo)
            # y2 = ElementoCampo(y2_bruto, primo)
            # p2 = Punto(x2, y2, a, b)
            if x2_bruto is None:
...
class PuntoS256(Punto):
    ...
    def sec(self, comprimido=True):
        ...
        if comprimido:
            ...
            # si no está comprimido, comienza con b'\x04' seguido por self.x y luego self.y
    ...
    def dire(self, comprimido=True, testnet=False):
        ...
        if testnet:
            ...
            prefijo = b'\x00'
        # deveuve codificar_base58_checksum del prefijo y h160
...
class PruebaS256(TestCase):
    ...
    def prueba_puntopub(self):
        ...
        for secreto, x, y in puntos:
            ...
            punto = PuntoS256(x, y)
            # comprueba que el secreto*G es el mismo que el punto
...
class ClavePrivada:
    ...
    def firmar(self, z):
        ...
        k = randint(0, 2**256)
        # r es la coordenada x del punt resultante k*G
        r = (k * G).x.num
