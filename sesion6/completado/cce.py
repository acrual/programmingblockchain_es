...
class ElementoCampo:
    ...
    def __truediv__(self, otro):
        ...
        # self.primo is what you'll need to mod against
        primo = self.primo
...
class Punto:
    ...
    def __add__(self, otro):
        ...
        # Caso 0.0: self es el punto en el infinito, devuelve
        if self.x is None:
            return otro
    ...
    def __rmul__(self, coeficiente):
        # rmul calculat coeficiente * self
        coef = coeficiente
        actual = self
        # start at 0
...
class PruebaPunto(TestCase):
    ...
    def prueba_en_curva(self):
        ...
        # estas no deberían dar un error
...
class PuntoS256(Punto):
    ...
    def verificar(self, z, firma):
        ...
        # v = r / s
        v = firma.r * s_inv % N
        # u*G + v*P deberían tener r como la coordenada x
        total = u * G + v * self
        return total.x.num == firma.r

    @classmethod
    def parsear(self, sec_bin):
        '''devuelve un objeto Punto desde un binario sec comprimido (no hex)
        '''
        if sec_bin[0] == 4:
...
class PruebaS256(TestCase):
    ...
    def prueba_puntopub(self):
        ...
        for secreto, x, y in puntos:
            ...
            punto = PuntoS256(x, y)
            # comprueba que secreto*G sea el mismo que el punto
