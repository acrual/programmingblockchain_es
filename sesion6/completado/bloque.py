...
class Bloque:
    ...
    def bip9(self):
        '''Devuelve si este Bloque seañaliza estar listo para BIP9'''
        # BIP9 se señaliza si los top 3 bits son 001
        # recuerda que versión es 32 bytes luego mueve a la derecha 29 (>> 29) y comprueba si
        # ese es 001
        return self.versión >> 29 == 0b001

    def bip91(self):
        '''Devuelve si este Bloque seañaliza estar listo para BIP91'''
        # BIP91 se señaliza si el 5º bit desde la derecha es 1
        # mueve 4 bits a la derecha y mira si el último bit es 1
    ...
    def bip141(self):
        ...
        # mueve 1 bit a la drecha y mira si el último bit es 1
    ...
    def dificultad(self):
        ...
        # la dificultad más baja tiene bits iguales a 0xffff001d
